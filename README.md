Whistle is the last group project developed during Le Wagon Berlin (batch #322). 
This project has been presented at Factory Berlin after the 9 weeks of coding Bootcamp.

This app is about alerting your friends instantly when you are harassed or feel unsafe in the street.
...
We also tend to create a partner establishments network in order for the user to see on the map the open establishements that can help on the spot.
